        ...
        <div id="generators">
          ...
          ${generators.map(genName => {
            ...
            Object.keys(generator).forEach(name => {
              // For embedding inputs to generators, set the vocab to the
              // embedding fields from the selected model.
              if (generator[name].__name__ as string === 'Embeddings') {
                generator[name].vocab = this.embeddingFields;
              }
            });
            return html`
